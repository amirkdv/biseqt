...
from util import plot_seeds, plot_similar_segment, adjust_pw_plot
...
def exp_local_alignment():
    ...
    homs = [rand_seq(A, i) for i in [200, 500, 1500, 2500]]

    def junk(): return rand_seq(A, np.random.randint(1000, 2000))
